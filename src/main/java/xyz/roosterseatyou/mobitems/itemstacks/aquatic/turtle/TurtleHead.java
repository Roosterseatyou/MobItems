...
public class TurtleHead {
    ...
    public static void turtleHead(){
        ...
        meta.addAttributeModifier(Attribute.GENERIC_ARMOR, new AttributeModifier(UUID.randomUUID(), "gen_armor", 10, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HEAD));
        //see AquaticUtils
        lore.add(ENTITY_ID);
        lore.add(CLASS_ID);
        meta.lore(lore);
