...
public class TurtleFeet {
    ...
    public static ItemStack TURTLE_FEET;
    ...
    public static void turtleFeet(){
        ...
        meta.addAttributeModifier(Attribute.GENERIC_ARMOR, new AttributeModifier(UUID.randomUUID(), "gen_armor", 10, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.FEET));
        //see AquaticUtils
        lore.add(ENTITY_ID);
        lore.add(CLASS_ID);
        meta.lore(lore);
