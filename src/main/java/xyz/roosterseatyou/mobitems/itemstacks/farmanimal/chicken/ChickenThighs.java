...
public class ChickenThighs {
    public static Component NAME = Component.text("Chicken Thighs");
    public static ItemStack CHICKEN_THIGHS;
    ...
    public static void chickenThighs(){
