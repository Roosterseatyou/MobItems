...
public class SnowGolemFeet {
    public static Component NAME = Component.text("Snowman Boots");
    ...
    public static ItemStack SNOW_FEET;
    ...
    public static void snowFeet(){
        ItemStack item = new ItemStack(Material.LEATHER_BOOTS);
        LeatherArmorMeta meta = (LeatherArmorMeta) item.getItemMeta();
        List<Component> lore = new ArrayList<>();
        meta.displayName(NAME);
        meta.setColor(Color.fromRGB(255, 255, 255));
        meta.addAttributeModifier(Attribute.GENERIC_ARMOR, new AttributeModifier(UUID.randomUUID(), "gen_armor", 4, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.FEET));
