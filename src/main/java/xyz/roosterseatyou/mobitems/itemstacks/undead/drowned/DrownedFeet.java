...
public class DrownedFeet {
    ...
    public static Component ENTITY_ID = Component.text("ENTITY ID: DROWNED").color(TextColor.fromHexString("#89E2C7")).decorate(TextDecoration.ITALIC);
    ...
    public static void drownedFeet(){
        ItemStack item = ItemUtils.genMobArmor(Material.LEATHER_BOOTS, NAME, ENTITY_ID, CLASS_ID_ONE, 5, EquipmentSlot.FEET, 5);
